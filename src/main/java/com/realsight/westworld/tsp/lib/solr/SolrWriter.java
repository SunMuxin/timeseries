...
public class SolrWriter{
	...
	public synchronized void write(MultipleDoubleSeries mSeries) throws Exception {
	...
	public synchronized void flush() throws SolrServerException, IOException {
	...
	public synchronized void close() throws IOException, SolrServerException {
